...
大象母系首领（matriarch）能导航到 **35–45 年未曾造访**的水源。硬证据是 1993 年坦桑尼亚 Tarangire 干旱：由 38 岁与 45 岁 matriarch 带领的象群离开干涸的园区、前往记忆中的水源并存活；由 33 岁 matriarch 带领的象群留下，损失了 **20% 的幼崽，是正常死亡率的十倍**。
